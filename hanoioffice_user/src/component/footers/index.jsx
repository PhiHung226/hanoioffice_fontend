    ...
    <>
      <div>
        <div className="grid grid-cols-3 gap-4 bg-black py-16">
          <div className="pl-28">
            <img className="w-64 h-10" src="https://hanoioffice.vn/wp-content/uploads/2021/02/logo-black.png" alt=""/>
            ...
            <NavLink to="" className="mx-6 text-white"> Chi Tiết + </NavLink>
          </div>
          <div className="pl-10 pr-10">
            ...
            <NavLink to="" className="text-white" href="">Liên Hệ +</NavLink>
          </div>
          <div>
        ...
        <div className="bg-gray-800 text-center">
          ...
          <NavLink to="https://www.dmca.com/Protection/Status.aspx?ID=1a302d9c-3192-4542-8cf9-becb750d7274&refurl=https://hanoioffice.vn/">
            <img className="inline-block h-13" src="https://images.dmca.com/Badges/dmca-badge-w100-5x1-02.png?ID=1a302d9c-3192-4542-8cf9-becb750d7274" alt="" />
          </NavLink>
        </div>
      </div>
    </>
