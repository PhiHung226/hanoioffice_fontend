...
import {
  ...
  ToHieu, TranPhu, Contact, Quotation,Introduce,CSNQ,
  Login,Register,ForgotPassword,ChangePassword,Profile
} from './Lazy';
    ...
    <>
      <Suspense fallback={ <LoadingSpinner /> }>
        <Switch>
          ...
          <Route exact path="/chinh-sach-chuyen-nhuong" component={ CSNQ } />
