...
export const listEmployeesColumnTableState = atom({
  ...
  default: [
    ...
    { field: 'position', headerName: 'Chức vụ', width: 150, sortable: false, description: 'Chức vụ' },
    { field: 'sex', headerName: 'Giới tính', width: 150, sortable: false, description: 'Giới tính' },
