...
export const listCustomerColumnTableState = atom({
  ...
  default: [
    ...
    { field: 'codeCustomer', headerName: 'Mã khách hàng', width: 150, sortable: false, description: 'Mã khách hàng' },
    ...
    { field: 'phoneNumber', headerName: 'Số điện thoại', width: 150, sortable: false, description: 'Số điện thoại khách hàng' },
    { field: 'email', headerName: 'Email', width: 250, sortable: false, description: 'Email khách hàng' },
    ...
    { field: 'createDate', headerName: 'Ngày đăng ký', width: 150, sortable: false, description: 'Ngày đăng ký' },
    { field: 'status', headerName: 'Trang thái', width: 150, sortable: false, description: 'Trạng thái sử dụng' },
