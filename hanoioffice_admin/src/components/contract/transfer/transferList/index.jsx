...
import DetailInfo from '../transferList/Dialog/DetailInfo';
import DialogDetail from '../transferList/Dialog/DialogDetail';
...
const TransferList = () => {
  ...
  const { data, refetch } = useQuery(
    [ 'PRODUCT_LIST_KEY_ROOM_SPECIES', page.skip, JSON.stringify(filterParams) ],
