      ...
      <div>
        <Controller
          ...
          render={ ({ field: { onChange, value } }) =>
            <TextFieldInput label="Mã tiện ích" className="w-full"
              onChange={ e => {
        ...
        <Controller
          ...
          rules={ { required: true } }
          render={ ({ field: { onChange, value } }) =>
            <TextFieldInput label="Tên tiện ích" className="w-full"
              onChange={ e => {
                onChange(e.target.value);
              } }
              value={ value }
        ...
        <Controller
          ...
          rules={ {} }
          render={ ({ field: { onChange, value } }) =>
            <TextFieldInput label="Số lượng tiện ích" className="w-full"
              onChange={ e => {
                onChange(e.target.value);
              } }
              value={ value }
